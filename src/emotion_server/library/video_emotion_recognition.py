...
def gen():
    ...
    while True :
        ...
        for (i, rect) in enumerate(rects):
            ...
            frustration_level = round(prediction[0][0],3) + round(prediction[0][1],3) + round(prediction[0][2],3) + round(prediction[0][4],3)
            cv2.putText(frame, "Frustration level : " + str(frustration_level),(40,280 + 180*i), cv2.FONT_HERSHEY_SIMPLEX, 0.5, 155, 1)
...
def gen2():
    ...
    cv2.imwrite('tmp/'+str(localtime)+'.jpg', frame)
    ...
    emotion_dict = {
        ...
        "Emotion": str(emotion),
        "FrustrationLevel": str(frustration_level)
    }
    print(emotion_dict)
